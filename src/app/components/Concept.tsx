            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {features.map((feat, i) => (
                  <motion.div
                      ...
                      className="group relative border border-white/10 bg-white/5 p-8 hover:bg-pink-900/10 transition-colors"
                      style={{ clipPath: "polygon(0 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%)" }}
                  >
                    <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                      <span className="text-xs font-mono text-pink-500">0{i + 1}</span>
                    </div>
                    <feat.icon className="w-8 h-8 text-pink-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
                    <h3
